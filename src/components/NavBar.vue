<template>
    <div class="bg-gray-900 text-gray-100 py-3.5 px-6 shadow md:flex justify-between items-center">
        <div class="flex items-center">
            <span class="text-green-500 text-xl mr-1 cursor-pointer">
                <i class="fa-brands fa-facebook-messenger"></i>
            </span>
            <h1 class="text-xl">Designer</h1>
        </div>

        <span @click="MenuOpen()" class="absolute md:hidden right-6 top-1.5 cursor-pointer text-3xl mt-1">
            <i :class="[open ? 'fa-sharp fa-solid fa-xmark' : 'fa-sharp fa-solid fa-bars']"></i>
        </span>
